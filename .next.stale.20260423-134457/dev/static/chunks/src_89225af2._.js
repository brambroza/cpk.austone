...
function CarsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CarsPage.useEffect": ()=>{
            setLoading(true);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/cars?page=${page}&per_page=${perPage}&search=${encodeURIComponent(search)}`).then({
                "CarsPage.useEffect": (data)=>{
                    setRows(data.items);
                    setTotal(data.total);
                }
            }["CarsPage.useEffect"]).finally({
                "CarsPage.useEffect": ()=>setLoading(false)
            }["CarsPage.useEffect"]);
        }
    }["CarsPage.useEffect"], [
        page,
...
_s(CarsPage, "Gagt1bz0UtbTSvT5WDsnCfVLZuk=");
_c = CarsPage;
var _c;
...
//# sourceMappingURL=src_89225af2._.js.map