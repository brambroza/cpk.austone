...
"[project]/src/app/(app)/tire-sizes/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TireSizesPage() {
    ...
    async function load() {
        ...
        setError("");
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/tire-sizes?search=${encodeURIComponent(search)}`);
            setRows(data.items);
        } catch (err) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TireSizesPage.useEffect": ()=>{
            const timer = window.setTimeout({
                "TireSizesPage.useEffect.timer": ()=>{
                    setSearch(searchInput.trim());
                    setPage(1);
                }
            }["TireSizesPage.useEffect.timer"], 300);
            return ({
                "TireSizesPage.useEffect": ()=>window.clearTimeout(timer)
            })["TireSizesPage.useEffect"];
        }
    }["TireSizesPage.useEffect"], [
        searchInput
    ...
    async function onAdd() {
        ...
        setError("");
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/api/tire-sizes", {
                method: "POST",
                body: JSON.stringify({
                    size: size.trim()
                })
    ...
    async function onEdit(row) {
        ...
        if (!nextSize) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/tire-sizes/${row.id}`, {
                method: "PUT",
                body: JSON.stringify({
                    size: nextSize.trim()
                })
    ...
    const totalPages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "TireSizesPage.useMemo[totalPages]": ()=>Math.ceil(rows.length / perPage)
    }["TireSizesPage.useMemo[totalPages]"], [
        rows.length
    ]);
...
_s(TireSizesPage, "WIEuVUBfmNI+eObg0mG4obrdQyc=");
_c = TireSizesPage;
var _c;
__turbopack_context__.k.register(_c, "TireSizesPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_79eebc45._.js.map