...
"[project]/src/app/(app)/stock/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function StockPage() {
    ...
    async function load() {
        ...
        setError("");
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/stock?page=${page}&per_page=${perPage}&search=${encodeURIComponent(search)}`);
            setRows(data.items);
            setTotal(data.total);
        } catch (err) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "StockPage.useEffect": ()=>{
            const timer = window.setTimeout({
                "StockPage.useEffect.timer": ()=>{
                    setPage(1);
                    setSearch(searchInput.trim());
                }
            }["StockPage.useEffect.timer"], 350);
            return ({
                "StockPage.useEffect": ()=>window.clearTimeout(timer)
            })["StockPage.useEffect"];
        }
    }["StockPage.useEffect"], [
        searchInput
    ...
    const totalPages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StockPage.useMemo[totalPages]": ()=>Math.ceil(total / perPage)
    }["StockPage.useMemo[totalPages]"], [
        total
    ]);
    function openDialog(target, mode) {
        setDialog({
            open: true,
            mode,
            target
    ...
    async function submitAdjust() {
        ...
        setError("");
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/stock/${dialog.target.id}/adjust`, {
                method: "POST",
                body: JSON.stringify({
                    method: dialog.mode,
                    amount
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            ...
                            children: "ข้อมูลคลังสินค้า"
                        }, void 0, false, {
                            fileName: "[project]/src/app/(app)/stock/page.tsx",
                            lineNumber: 103,
                            columnNumber: 11
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-sm text-slate-500",
                            children: "ติดตามจำนวนยางคงเหลือ"
                        }, void 0, false, {
                            fileName: "[project]/src/app/(app)/stock/page.tsx",
                            lineNumber: 104,
                            columnNumber: 11
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                    children: loading ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                        ...
                                        }, `${row.id}-${row.company || "na"}-${idx}`, true, {
                                            fileName: "[project]/src/app/(app)/stock/page.tsx",
                                            lineNumber: 153,
                                            columnNumber: 19
                                        }, this))
            ...
            dialog.open && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                            ...
                                            children: dialog.mode === "add" ? "เพิ่มจำนวนสินค้า" : "ลดจำนวนสินค้า"
                                        }, void 0, false, {
                                            fileName: "[project]/src/app/(app)/stock/page.tsx",
                                            lineNumber: 196,
                                            columnNumber: 17
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            className: "text-xs text-slate-500",
                                            children: [
                                                dialog.target?.identity || dialog.target?.id,
                                                " • ",
                                                dialog.target?.brand,
                                                " • ",
                                                dialog.target?.size,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                    ...
                                    className: "rounded-xl border border-blue-100 bg-white px-4 py-2 text-sm font-semibold text-slate-600",
                                    children: "ยกเลิก"
                                }, void 0, false, {
                                    fileName: "[project]/src/app/(app)/stock/page.tsx",
                                    lineNumber: 233,
...
_s(StockPage, "YyJFllY6GhJkvYMLssRUz4KHGRs=");
_c = StockPage;
var _c;
...
//# sourceMappingURL=src_4d69095c._.js.map