...
"[project]/src/app/(app)/brand-cars/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BrandCarsPage() {
    ...
    async function load() {
        ...
        setError("");
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/brand-cars?search=${encodeURIComponent(search)}`);
            setRows(data.items);
        } catch (err) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "BrandCarsPage.useEffect": ()=>{
            const timer = window.setTimeout({
                "BrandCarsPage.useEffect.timer": ()=>{
                    setSearch(searchInput.trim());
                    setPage(1);
                }
            }["BrandCarsPage.useEffect.timer"], 300);
            return ({
                "BrandCarsPage.useEffect": ()=>window.clearTimeout(timer)
            })["BrandCarsPage.useEffect"];
        }
    }["BrandCarsPage.useEffect"], [
        searchInput
    ...
    async function onAdd() {
        ...
        setError("");
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])("/api/brand-cars", {
                method: "POST",
                body: JSON.stringify({
                    name: name.trim()
                })
    ...
    async function onEdit(row) {
        ...
        if (!nextName) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/brand-cars/${row.id}`, {
                method: "PUT",
                body: JSON.stringify({
                    name: nextName.trim()
                })
    ...
    const totalPages = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "BrandCarsPage.useMemo[totalPages]": ()=>Math.ceil(rows.length / perPage)
    }["BrandCarsPage.useMemo[totalPages]"], [
        rows.length
    ]);
...
_s(BrandCarsPage, "kGDy1FRG+ayZgnh6NknJl1S/HII=");
_c = BrandCarsPage;
var _c;
__turbopack_context__.k.register(_c, "BrandCarsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_b051b172._.js.map