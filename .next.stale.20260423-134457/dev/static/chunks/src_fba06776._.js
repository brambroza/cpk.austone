...
function CarsPage() {
    ...
    function load() {
        setLoading(true);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/cars?page=${page}&per_page=${perPage}&search=${encodeURIComponent(search)}`).then((data)=>{
...
_s(CarsPage, "A+Z0gAfKPeiivvvdID1jNValfCY=");
_c = CarsPage;
var _c;
...
//# sourceMappingURL=src_fba06776._.js.map