...
"[project]/src/app/(app)/brand-cars/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BrandCarsPage() {
    ...
    async function load() {
        ...
        setError("");
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/brand-cars?search=${encodeURIComponent(search)}`);
            setRows(data.items);
        } catch (err) {
    ...
    async function onAdd() {
        ...
        setError("");
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])("/api/brand-cars", {
                method: "POST",
                body: JSON.stringify({
                    name: name.trim()
                })
    ...
    async function onEdit(row) {
        ...
        if (!nextName) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/brand-cars/${row.id}`, {
                method: "PUT",
                body: JSON.stringify({
                    name: nextName.trim()
                })
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("h1", {
                            ...
                            fileName: "[project]/src/app/(app)/brand-cars/page.tsx",
                            lineNumber: 92,
                            columnNumber: 11
                        }, this),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            className: "text-sm text-slate-500",
                            children: "จัดการยี่ห้อรถในระบบ"
                        }, void 0, false, {
                            fileName: "[project]/src/app/(app)/brand-cars/page.tsx",
                            lineNumber: 93,
                            columnNumber: 11
...
//# sourceMappingURL=src_2a9d38f4._.js.map