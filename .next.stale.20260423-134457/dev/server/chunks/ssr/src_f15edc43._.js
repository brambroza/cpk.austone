...
"[project]/src/app/(app)/brand-tires/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function BrandTiresPage() {
    ...
    async function load() {
        ...
        setError("");
        try {
            const data = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/brand-tires?search=${encodeURIComponent(search)}`);
            setRows(data.items);
        } catch (err) {
    ...
    async function onAdd() {
        ...
        setError("");
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])("/api/brand-tires", {
                method: "POST",
                body: JSON.stringify({
                    name: name.trim()
                })
    ...
    async function onEdit(row) {
        ...
        if (!nextName) return;
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiFetch"])(`/api/brand-tires/${row.id}`, {
                method: "PUT",
                body: JSON.stringify({
                    name: nextName.trim()
                })
...
//# sourceMappingURL=src_f15edc43._.js.map